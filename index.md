...
helper: ["Jessica Holmes","Joyce Njuguna", "Maxim Belkin"]     # boxed, comma-separated list of helpers' names
email: ["training@cse.illinois.edu"]    # boxed, comma-separated list of contact email addresses for the host
collaborative_notes: "https://pad.carpentries.org/2019-09-26-illinois"            # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document
